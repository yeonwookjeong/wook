...
- `lib/sillok.ts`: 가상 실록 생성(일간·일지·띠·시지로 결정, 같은 사주는 항상 같은 실록). 즉위→치세의 시작→시련→전성기→야사→승하 6장 이야기로, 조정의 영의정·간신·유배·일반 신하 이름이 등장인물로 들어감. 향년은 24~88세(중앙 56세)로 뽑고 조선 27왕 실제 향년과 비교해 수명 순위를 매김. 평균 수명 46.1세·영조 82세는 황상익 교수 연구 인용(문화일보)
